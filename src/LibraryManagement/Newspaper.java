...
public class Newspaper extends Item
{
 ...
 private  final int publisherCharges=5;
    ...
    {
        System.out.println("LibraryManagement.Newspaper ID: "+this.getId());
        System.out.println("LibraryManagement.Newspaper Tittle: "+this.getTittle());
        System.out.println("LibraryManagement.Newspaper Publisher: "+this.getPublisher());
        System.out.println("LibraryManagement.Newspaper Popularity Count: "+this.getPopularityCount());
        System.out.println("LibraryManagement.Newspaper Date: "+this.getDate());
        System.out.println("LibraryManagement.Newspaper Total Cost: "+this.calculateCost());
    }
    @Override
    public void edit()
    {
